...
{
    public sealed class MatcherQueryFullTextTest
    {
        private static readonly ILogger<MatcherQueryFullTextTest> LOGGER =
                LoggerFactory.Create(b => b.AddDebug().AddConsole())
                .CreateLogger<MatcherQueryFullTextTest>();
        ...
        public static IEnumerable<object?[]> Data(int numTests)
        {
            ...
            return new List<object?[]>
            {
                ...
                new object?[]{"fullTextNoFullTextFieldsContentDoc", contentDocument, simpleFullTextFilter, NO_CONFIGURED_FULLTEXT_FIELDS, false, false},
                ...
                new object?[]{"andFullTextNoFullTextFieldsContentDoc", contentDocument, andFullTextFilter, NO_CONFIGURED_FULLTEXT_FIELDS, false, false},
                ...
                // VQL: (Julie NEAR3 Shakespeare) AND (Romeo)
                ...
                new object?[]{"orFullTextNoFullTextFieldsContentDoc", contentDocument, orFullTextFilter, NO_CONFIGURED_FULLTEXT_FIELDS, false, false},
                ...
                // VQL: (NOT Julie*) Filter.fullTextFilter(not(fullTextFilter))
                new object?[]{"notFullTextFilterNullFullTextFieldsContentDoc", contentDocument, filterNotFullText, null, false, true},
                new object?[]{"notFullTextFilterNullFullTextFieldsMetadataDoc", metadataOnlyDocument, filterNotFullText, null, false, true},
                ...
                new object?[]{"notFullTextAvailableFullTextFieldsFilterMetadataDoc", metadataOnlyDocument, filterNotFullText, CONFIGURED_FULLTEXT_FIELDS,
                 true, false},
                // VQL: (NOT Julie*) Filter.not(fullTextFilter)
                new object?[]{"notFilterFullTextNullFullTextFieldsContentDoc", contentDocument, notFilterOfFullText, null, false, true},
                new object?[]{"notFilterFullTextNullFullTextFieldsMetadataDoc", metadataOnlyDocument, notFilterOfFullText, null, false, true},
        ...
        private static Filter<string> GetSimpleFullTextFilter()
        {
            ...
            return FilterFactory.FullText<string>(julieAny);
        }
        ...
        private static Filter<string> GetAndFullTextFilter()
        {
            ...
            Filter<string> fullTextFiltersAnd = FilterFactory.FullText<string>(FullTextFilterFactory.And(julieAny, anyShakespeare));
        ...
        private static Filter<string> GetAndOnlyFullTextFilter()
        {
            ...
            return FilterFactory.FullText<string>(FullTextFilterFactory.And(nearFilter, romeoFilter));
        }
        ...
        private static Filter<string> GetOrFullTextFilter()
        {
            ...
            FullTextFilter anyShakespeare = FullTextFilterFactory.FullText(
                LikeTokenFactory.ZeroOrMoreCharactersWildcard(),
                (LikeTokenFactory.StringLiteral("Shakespeare")));
            return FilterFactory.FullText<string>(FullTextFilterFactory.Or(julieAny, anyShakespeare));
        }
        ...
        private static Filter<string> GetFilterOfNotFullText()
        {
            ...
            return FilterFactory.FullText<string>(notJulieAny);
        }
        ...
        private static Filter<string> GetNotFilterOfFullText()
        {
            FullTextFilter julieAny = FullTextFilterFactory.FullText(
                LikeTokenFactory.StringLiteral("Julie"),
                LikeTokenFactory.ZeroOrMoreCharactersWildcard());
            Filter<string> filter = FilterFactory.FullText<string>(julieAny);
